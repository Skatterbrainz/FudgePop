...
.PARAMETER ComputerName
	[string-array][optional] Name of one or more computers to query.  A separate
...
h1,h2,h3 {font-family:arial,sans;}
TABLE {border-width:1px; border-style:solid; border-color:black; border-collapse:collapse; background-color:#fff;}
TH {border-width:1px; padding:5px; border-style:solid; border-color:#e1e1e1; font-family:verdana; font-size:10pt;}
TD {border-width:1px; padding:5px; border-style:solid; border-color:#e1e1e1; font-family:verdana; font-size:10pt;}
.footer {text-align:center; font-size:10pt; font-family:verdana;}
</style>
"@
	...
	foreach ($computer in $ComputerName) {
		...
		$html += "`n<p class=`"footer`">Copyright &copy; 2017 - All Rights Reserved.</p>"
		$html | ConvertTo-Html -Head $style -Body $html -Title $cname | Out-File $fullpath
